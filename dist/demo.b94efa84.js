...
},{"./cjs/react-dom.development.js":"node_modules/react-dom/cjs/react-dom.development.js"}],"demo/store/documents.js":[function(require,module,exports) {
"use strict";
...
var mutations = {
  setDocuments: function setDocuments(state, d) {
    state.documents = d;
  }
};
var getters = {
...
},{}],"demo/store/notes.js":[function(require,module,exports) {
"use strict";
...
exports.default = _default;
},{}],"src/module/module.js":[function(require,module,exports) {
"use strict";
...
function () {
  ...
  _createClass(Module, [{
    ...
    value: function forEachChild(fn) {
      return Object.entries(this._children).forEach(function (pairs) {
        fn(pairs[0], pairs[1]);
      });
    }
  }, {
    ...
    value: function forEachMutation(fn) {
      if (this._rawModule.mutations) {
        Object.entries(this._rawModule.mutations).forEach(function (pairs) {
          fn(pairs[0], pairs[1]);
        });
      }
    }
...
},{}],"src/module/module-collection.js":[function(require,module,exports) {
"use strict";
  ...
  _createClass(ModuleCollection, [{
    ...
    value: function register(path, rawModule) {
      ...
      if (path.length === 0) {
        ...
        var parent = this.get(path.slice(0, -1)); // console.log("parent", path, parent);
      ...
      if (rawModule.modules) {
        ...
        Object.entries(rawModule.modules).forEach(function (pair) {
          _this.register(path.concat(pair[0]), pair[1], runtime);
        });
      }
    }
  }]);
...
},{"./module":"src/module/module.js"}],"src/utils/observer.js":[function(require,module,exports) {
"use strict";
...
function defineReactive(obj, key, val) {
  ...
  Object.defineProperty(obj, key, {
    ...
    set: function reactiveSetter(newVal) {
      console.log("setting new val", newVal); // obj[key] = val;
...
function observe(value, asRootData) {
  ...
  if (hasOwn(value, '__ob__') && value.__ob__ instanceof Observer) {
    ob = value.__ob__;
  } else if (shouldObserve && !isServerRendering() && (Array.isArray(value) || isPlainObject(value)) && Object.isExtensible(value)) {
...
function () {
  function Store() {
    ...
    _defineProperty(this, "_committing", false);

    _defineProperty(this, "_actions", {});

    _defineProperty(this, "_actionSubscribers", {});

    _defineProperty(this, "_mutations", {});

    _defineProperty(this, "_wrappedGetters", {});

    _defineProperty(this, "_subscribers", []);

    var vm = new _react.default.Component();
  ...
  _createClass(Store, [{
    ...
    value: function commit(type, payload) {
      ...
      if (!entry) {
        console.error("[reactx] unknown mutation type: ".concat(type));
        return;
      }
...
function resetStoreVM(store, state, hot) {
  var oldVm = store._vm;
  store.getters = {};
  store._vm = new _react.default.Component({
    $$state: state
  });
}

function installModule(store, rootState, path, module, hot) {
  var isRoot = !path.length; // const namespace = store._modules.g

  if (!isRoot && !hot) {
    var parentState = getNestedState(rootState, path.slice(0, -1));
    var moduleName = path[path.length - 1];
    (0, _observer.set)(parentState, moduleName, module.state); // parentState[moduleName] = module.state;

    console.log("pa", parentState); // store._withCommit(() => {
  ...
  module.forEachChild(function (key, child) {
...
},{"./module/module-collection":"src/module/module-collection.js","react":"node_modules/react/index.js","./utils/observer":"src/utils/observer.js"}],"src/components/Provider.js":[function(require,module,exports) {
"use strict";
...
function (_React$Component) {
  ...
  _createClass(Provider, [{
    ...
    value: function subscribe() {
      var store = this.props.store; // store.stateChange((state) => {
...
exports.default = _default;
},{"./store":"src/store.js","./components/Provider":"src/components/Provider.js"}],"demo/store/index.js":[function(require,module,exports) {
"use strict";
...
var _default = new _index.default.Store({
  modules: {
...
exports.default = _default;
},{"./documents":"demo/store/documents.js","./notes":"demo/store/notes.js","../../src/index":"src/index.js"}],"demo/index.js":[function(require,module,exports) {
"use strict";
...
var Provider = _index.default.Provider;
...
function (_React$Component) {
  ...
  _createClass(App, [{
    ...
    value: function componentDidMount() {
      setTimeout(function () {
        console.log("test", _store.default.state);
        _store.default.state.documents.documents = ["hi"];
      }, 1000);
    }
  }, {
    key: "render",
    value: function render() {
      return _react.default.createElement(Provider, {
        ...
        className: "app"
      }, _react.default.createElement("h2", null, "App")));
    }
  }]);
...
},{"react":"node_modules/react/index.js","react-dom":"node_modules/react-dom/index.js","./store":"demo/store/index.js","../src/index":"src/index.js"}],"../../../../../usr/local/lib/node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
